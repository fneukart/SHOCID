...
<%@ page
	import="shocid.ffann.committee.application.RadialBasisFunctionCApplicationJSP"%>
...
<script language="JavaScript"
	src="C:\\Users\\Florian Radial Basis Function with RPROP \\workspace\\SHOCID_310\\FusionChartsFree\\JSClass\\FusionCharts.js"></script>
...
<body>
	<h1 class="heading">Radial Basis Function with RPROP  classification results</h1>
	...
	<%
            ...
            int numberAgents = RadialBasisFunctionCApplicationJSP.getNumberCommitteeMembers();

            int numberInputNeurons = RadialBasisFunctionCApplicationJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = RadialBasisFunctionCApplicationJSP.getNumberOutputNeurons();
           MLDataSet trainingSet = RadialBasisFunctionCApplicationJSP
                    .getCommitteeTrainingSet();
            int col = 0;
            double[][] inputValuesArray = RadialBasisFunctionCApplicationJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = RadialBasisFunctionCApplicationJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = RadialBasisFunctionCApplicationJSP.getAverageExpertValuesGUI();
    %>

	<div id="AccordionCommittee" class="Accordion">
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Neuron outputs per Radial Basis Function with RPROP  agent</div>
			<div class="AccordionPanelContent">
				<h3>Radial Basis Function with RPROP propagation committee agent 1:</h3>
				<table border=5>
					<%
        ...
        {
            %>
				<h3>Radial Basis Function with RPROP committee agent 2:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Radial Basis Function with RPROP committee agent 3:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Radial Basis Function with RPROP committee agent 4:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Radial Basis Function with RPROP committee agent 5:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
