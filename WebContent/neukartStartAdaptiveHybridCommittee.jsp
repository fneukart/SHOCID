...
<%@ page import="shocid.neukart.NeukartHCJSP"%>
<%@ page import="shocid.neukart.adaptive.NeukartAdaptiveHybridJSP"%>
...
<title>Neukart Adaptive Hybrid Data Processing</title>
<link href="SpryAssets/SpryAccordion.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<h1 class="heading">Neukart adaptive hybrid classification results</h1>
	...
	<%
            ...
            int numberInputNeurons = NeukartHCJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = NeukartHCJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = NeukartHCJSP
            ...
            int col = 0;
            double[][] inputValuesArray = NeukartHCJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = NeukartHCJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = NeukartHCJSP.getAverageExpertValuesGUI();
            ...
            switch(numberAgents)
                {
                case 1:
                    agent1Errors = NeukartHCJSP.getAgentErrors(1);
                    
                    agent1Epochs = AdaptiveHybridHOANNCommitteeJSP.getExpertEpochs(1);
                    break;
                case 2:
                    agent1Errors = NeukartHCJSP.getAgentErrors(1);
                    agent2Errors = NeukartHCJSP.getAgentErrors(2);
                ...
                case 3:
                    agent1Errors = NeukartHCJSP.getAgentErrors(1);
                    agent2Errors = NeukartHCJSP.getAgentErrors(2);
                    agent3Errors = NeukartHCJSP.getAgentErrors(3);
                ...
                case 4:
                    ...
                    agent2Errors = NeukartHCJSP.getAgentErrors(2);
                    agent3Errors = NeukartHCJSP.getAgentErrors(3);
                    agent4Errors = NeukartHCJSP.getAgentErrors(4);
                ...
                case 5:
                    ...
                    agent3Errors = NeukartHCJSP.getAgentErrors(3);
                    agent4Errors = NeukartHCJSP.getAgentErrors(4);
                    agent5Errors = NeukartHCJSP.getAgentErrors(5);
	...
	<div id="AccordionCommittee" class="Accordion">
			...
			<div class="AccordionPanelContent">
                ...
                //Agent 1 Graph
                    //Graph
                        ...
                        strXMLA1 = "<graph caption='Error over generations - neukart agent 1' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 2 Graph
                 //Graph
                     ...
                     int a2 = 0;
                     //Initialize graph element
                     strXMLA2 = "<graph caption='Error over generations - Neukart agent 2' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 3 Graph
                 //Graph
                     ...
                     int a3 = 0;
                     //Initialize graph element
                     strXMLA3 = "<graph caption='Error over generations - neukart agent 3' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 4 Graph
                 //Graph
                     ...
                     int a4 = 0;
                     //Initialize graph element
                     strXMLA4 = "<graph caption='Error over generations - neukart agent 4' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 5 Graph
                 //Graph
                     ...
                     int a5 = 0;
                     //Initialize graph element
                     strXMLA5 = "<graph caption='Error over generations - neukart agent 5' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<table border=1>
					<tr>
						<th><h3>
								Neukart agent 1 needed to evolve
						...
						<%if (numberAgents >= 2)
                               {%>
						<th><h3>
								Neukart agent 2 needed to evolve
						...
						<%if (numberAgents >= 3)
                               {%>
						<th><h3>
								Neukart agent 3 needed to evolve
						...
						<%if (numberAgents >= 4)
                               {%>
						<th><h3>
								Neukart agent 4 needed to evolve
						...
						<%if (numberAgents == 5)
                               {%>
						<th><h3>
								Neukart agent 5 needed to evolve
		...
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Neuron outputs per Neukart agent</div>
			<div class="AccordionPanelContent">
				<h3>Neural neukart committee agent 1:</h3>
				<table border=5>
					<%
        ...
        {
            %>
				<h3>Neural neukart committee agent 2:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural neukart committee agent 3:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural neukart committee agent 4:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural neukart committee agent 5:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<%
                    ...
                    if (NeukartAdaptiveHybridJSP.getBestSHLNetworkQuality() < NeukartAdaptiveHybridJSP
                            .getBestMHLNetworkQuality()) {
                        bestNetwork = NeukartAdaptiveHybridJSP
				...
				<p>
					...
					<%
                        ...
                        bestEpochs = NeukartAdaptiveHybridJSP.getBestEpochs();
                    %>
				...
				<table border=0 width=100%>
					<%
                        ...
                        int epochsSHL = 0;
                        for (int i = 0; i < NeukartAdaptiveHybridJSP
                                .getQualitySHLArray().length; i++) {
                            qualitySHL = NeukartAdaptiveHybridJSP
                                    .getQualitySHLArray(i);
                            epochsSHL = NeukartAdaptiveHybridJSP.getEpochsSL(i);
                    %>
					<tr>
				...
				<table border=0 width=100%>
					<%
                        ...
                        for (int i = 0; i < NeukartAdaptiveHybridJSP
                            ...
                            qualityMHL = NeukartAdaptiveHybridJSP
                                    .getQualityMHLArray(i);
                            epochsMHL = NeukartAdaptiveHybridJSP.getEpochsML(i);
                    %>
					<tr>
		...
		<h3>Neural neukart committee has automatically been saved
