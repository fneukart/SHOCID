		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<%
					...
					ElmanAdaptiveGeneticAlgorithmJSP.getBestSHLNetworkQuality();
						bestNetwork = ElmanAdaptiveGeneticAlgorithmJSP
				...
				<p>
					<%
						ElmanAdaptiveGeneticAlgorithmJSP.getBestSHLNetworkQuality();
							hn1 = ElmanAdaptiveGeneticAlgorithmJSP
					...
					<%
						...
						bestEpochs = ElmanAdaptiveGeneticAlgorithmJSP.getBestEpochs();
					%>
				...
				<table border=0 width=100%>
					<%
						...
						int epochsSHL = 0;
						for (int i = 0; i < ElmanAdaptiveGeneticAlgorithmJSP
								.getQualitySHLArray().length; i++) {
							qualitySHL = ElmanAdaptiveGeneticAlgorithmJSP
									.getQualitySHLArray(i);
							epochsSHL = ElmanAdaptiveGeneticAlgorithmJSP.getEpochsSL(i);
					%>
					<tr>
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<form id="form1" name="form1" method="post"
					action="elmanAdaptiveSingleDetails.jsp">
					<table>
						<tr>
							<td>
								<div id="SHLAgentDetails">
									<label for="SHLAgentDetails">SHL agent evolution
										...
										name="showSHLAgentDetails" size="1" id="showSHLAgentDetails">
											<%
												for (int networks = 0; networks < ElmanAdaptiveGeneticAlgorithmJSP
