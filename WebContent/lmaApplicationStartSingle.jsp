...
<%@ page import="shocid.ffann.application.FFANNLevenbergMarquardtApplicationJSP"%>
...
<body>
	<h1 class="heading">Levenberg Marquardt classification results</h1>
		...
		<%
			...
			MLDataSet trainingSet = FFANNLevenbergMarquardtApplicationJSP.getTrainingSet();
			BasicNetwork network = FFANNLevenbergMarquardtApplicationJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNLevenbergMarquardtApplicationJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNLevenbergMarquardtApplicationJSP
					.getOutputValues();
		%>
