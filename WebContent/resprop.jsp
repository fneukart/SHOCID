...
<title>Resilient Propagation Classification</title>
<style type="text/css">
body,td,th {
...
<body>
	<h3>Resilient propagation data processing</h3>
	<p>Shall the task be processed with a single agent or a democratic
		committee of agents?</p>

	<form id="form1" name="form1" method="post" action="respropMiddler.jsp">
...
<h3>File attributes</h3>
		...
		<label for="allowedError"></label> <input type="text"
			...
			name="trainingMethod" type="hidden" id="trainingMethod" value="r" />
