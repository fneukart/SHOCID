...
<%@ page
	import="shocid.ffann.committee.application.ResilientPropagationCApplicationJSP"%>
...
<script language="JavaScript"
	src="C:\\Users\\Florian Resilient Propagation\\workspace\\SHOCID_310\\FusionChartsFree\\JSClass\\FusionCharts.js"></script>
...
<body>
	...
	<%
            ...
            int numberAgents = ResilientPropagationCApplicationJSP.getNumberCommitteeMembers();

            int numberInputNeurons = ResilientPropagationCApplicationJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = ResilientPropagationCApplicationJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = ResilientPropagationCApplicationJSP
                    .getCommitteeTrainingSet();
            int col = 0;
            double[][] inputValuesArray = ResilientPropagationCApplicationJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = ResilientPropagationCApplicationJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = ResilientPropagationCApplicationJSP.getAverageExpertValuesGUI();
    %>

	<div id="AccordionCommittee" class="Accordion">
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Neuron outputs per Resilient Propagation agent</div>
			<div class="AccordionPanelContent">
				<h3>Neural Resilient Propagation propagation committee agent 1:</h3>
				<table border=5>
					<%
