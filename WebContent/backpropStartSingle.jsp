...
//  					+ request.getParameter("output");
	...
	<div id="AccordionSingle" class="Accordion">
		<%
			int numberInputNeurons = FFANNBackPropagationJSP
					.getNumberInputNeurons();
        int numberOutputNeurons = Integer
        .valueOf(numberOutputNeuronsString).intValue();
			MLDataSet trainingSet = FFANNBackPropagationJSP
					.getTrainingSet();
			BasicNetwork network = FFANNBackPropagationJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNBackPropagationJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNBackPropagationJSP
					.getOutputValues();
			double[][] idealValuesArray = FFANNBackPropagationJSP
					.getIdealValues();
			double[] error = FFANNBackPropagationJSP.getError();
			int epochs = FFANNBackPropagationJSP.getEpochs();
		%>
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Error over generations - graph
				of backpropagation agent</div>
