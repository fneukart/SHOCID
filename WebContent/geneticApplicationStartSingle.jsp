...
<%@ page import="shocid.ffann.application.FFANNGeneticAlgorithmApplicationJSP"%>
...
// 					+ request.getParameter("output");
			...
			MLDataSet trainingSet = FFANNGeneticAlgorithmApplicationJSP.getTrainingSet();
			BasicNetwork network = FFANNGeneticAlgorithmApplicationJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNGeneticAlgorithmApplicationJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNGeneticAlgorithmApplicationJSP
					.getOutputValues();
		%>
