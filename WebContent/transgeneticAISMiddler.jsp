...
<body>
    ...
    %>
    <jsp:forward page="transgeneticAISStartSingle.jsp" />
    <%
        } else if (committee_or_single.equals("es")) {
    %>
    <jsp:forward page="geneticStartAdaptiveSingle.jsp" />
    <%
        } else if (committee_or_single.equals("c")) {
    %>
    <jsp:forward page="geneticStartCommittee.jsp" />
    <%
        } else if (committee_or_single.equals("ec")) {
    %>
    <jsp:forward page="geneticStartAdaptiveHybridCommittee.jsp" />
    <%
        }
    %>
