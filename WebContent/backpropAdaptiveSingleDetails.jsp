...
<%@ page import="shocid.ffann.training.adaptive.FFANNAdaptiveBackPropagationJSP"%>
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				...
				<%
					...
					if (FFANNAdaptiveBackPropagationJSP.getErrorsSL(SHLAgentNumber).length > 500) {
						errorSelected = new double[500];
						jump = Math.round(FFANNAdaptiveBackPropagationJSP
								.getErrorsSL(SHLAgentNumber).length / 500);

						for (int i = 0; i < 500; i++) {
							errorSelected[i] = FFANNAdaptiveBackPropagationJSP
									.getErrorsSL(SHLAgentNumber)[position];
							position = position + jump;
						}
					} else {
						errorSelected = FFANNAdaptiveBackPropagationJSP
			...
			<div class="AccordionPanelContent">
				...
				<%
					...
					if (FFANNAdaptiveBackPropagationJSP.getErrorsML(MHLAgentNumber).length > 500) {
						errorSelected = new double[500];
						jump = Math.round(FFANNAdaptiveBackPropagationJSP
