...
<body>
	...
	<div id="AccordionSingle" class="Accordion">
		<%
			int numberInputNeurons = FFANNManhattanUpdateJSP
					.getNumberInputNeurons();
			int numberOutputNeurons = Integer
					.valueOf(numberOutputNeuronsString).intValue();
			MLDataSet trainingSet = FFANNManhattanUpdateJSP
					.getTrainingSet();
			BasicNetwork network = FFANNManhattanUpdateJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNManhattanUpdateJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNManhattanUpdateJSP
					.getOutputValues();
			double[][] idealValuesArray = FFANNManhattanUpdateJSP
					.getIdealValues();
			double[] error = FFANNManhattanUpdateJSP.getError();
			int epochs = FFANNManhattanUpdateJSP.getEpochs();
		%>
