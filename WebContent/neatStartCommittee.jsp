...
<%@ page import="shocid.neatpopulation.NEATPopulationCJSP"%>
...
<title>NEAT Data Processing</title>
<link href="SpryAssets/SpryAccordion.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<h1 class="heading">NEAT classification results</h1>
	...
	<%
            ...
            int numberInputNeurons = NEATPopulationCJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = NEATPopulationCJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = NEATPopulationCJSP
            ...
            int col = 0;
            double[][] inputValuesArray = NEATPopulationCJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = NEATPopulationCJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = NEATPopulationCJSP.getAverageExpertValuesGUI();
            ...
            switch(numberAgents)
                {
                case 1:
                    agent1Errors = NEATPopulationCJSP.getAgentErrors(1);
                    
                    agent1Epochs = HOANNCommitteeJSP.getExpertEpochs(1);
                    break;
                case 2:
                    agent1Errors = NEATPopulationCJSP.getAgentErrors(1);
                    agent2Errors = NEATPopulationCJSP.getAgentErrors(2);
                ...
                case 3:
                    agent1Errors = NEATPopulationCJSP.getAgentErrors(1);
                    agent2Errors = NEATPopulationCJSP.getAgentErrors(2);
                    agent3Errors = NEATPopulationCJSP.getAgentErrors(3);
                ...
                case 4:
                    ...
                    agent2Errors = NEATPopulationCJSP.getAgentErrors(2);
                    agent3Errors = NEATPopulationCJSP.getAgentErrors(3);
                    agent4Errors = NEATPopulationCJSP.getAgentErrors(4);
                ...
                case 5:
                    ...
                    agent3Errors = NEATPopulationCJSP.getAgentErrors(3);
                    agent4Errors = NEATPopulationCJSP.getAgentErrors(4);
                    agent5Errors = NEATPopulationCJSP.getAgentErrors(5);
            ...
            double[][] idealValuesArray = NEATPopulationCJSP
                    .getIdealValues();
            int epochs = NEATPopulationCJSP.getEpochs();
    %>
	...
	<div id="AccordionCommittee" class="Accordion">
			...
			<div class="AccordionPanelContent">
                ...
                //Agent 1 Graph
                    //Graph
                        ...
                        strXMLA1 = "<graph caption='Error over generations - NEAT agent 1' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 2 Graph
                 //Graph
                     ...
                     int a2 = 0;
                     //Initialize graph element
                     strXMLA2 = "<graph caption='Error over generations - NEAT agent 2' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 3 Graph
                 //Graph
                     ...
                     int a3 = 0;
                     //Initialize graph element
                     strXMLA3 = "<graph caption='Error over generations - NEAT agent 3' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 4 Graph
                 //Graph
                     ...
                     int a4 = 0;
                     //Initialize graph element
                     strXMLA4 = "<graph caption='Error over generations - NEAT agent 4' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 5 Graph
                 //Graph
                     ...
                     int a5 = 0;
                     //Initialize graph element
                     strXMLA5 = "<graph caption='Error over generations - NEAT agent 5' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
		...
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Neuron outputs per NEAT agent</div>
			<div class="AccordionPanelContent">
				<h3>Neural NEAT committee agent 1:</h3>
				<table border=5>
					<%
        ...
        {
            %>
				<h3>Neural NEAT committee agent 2:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural NEAT committee agent 3:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural NEAT committee agent 4:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural NEAT committee agent 5:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
		...
		<h3>Neural NEAT committee has automatically been saved under
