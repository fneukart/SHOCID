...
<body>
	<h1 class="heading">Cortical processing results</h1>
	...
	<%
            ...
            int numberAgents = CorticalCApplicationJSP.getNumberCommitteeMembers();

            int numberInputNeurons = CorticalCApplicationJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = CorticalCApplicationJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = CorticalCApplicationJSP
                    .getCommitteeTrainingSet();
            int col = 0;
            double[][] inputValuesArray = CorticalCApplicationJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = CorticalCApplicationJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = CorticalCApplicationJSP.getAverageExpertValuesGUI();
    %>
