...
<title>Neukart Classification</title>
<style type="text/css">
body,td,th {
...
<body>
	<h3>Neukart data processing</h3>
	<p>Shall the task be processed with a single agent or a democratic
		committee of agents?</p>

	<form id="form1" name="form1" method="post" action="neukartMiddler.jsp">
			...
			<tr>
				<td><label for="agents"></label> <select name="agents" size="1"
					id="agents" onchange="showNumberAgents()">
						...
						<option value=3>Evolving Single Agent</option>
						<option value=2>Evolving Hybrid Democratic Committee</option>
				</select>
				</td>
				<td>
					<div id="numberAgents">
...
<h3>File attributes</h3>
		...
		<label for="allowedError"></label> <input type="text"
			...
			name="trainingMethod" type="hidden" id="trainingMethod"
			value="neukart" /> </span> <span id="form1"> <input
			name="networkType" type="hidden" id="networkType" value="1" /> </span> <input
			type="submit" name="execute" id="execute" value="Execute" />
	</form>
