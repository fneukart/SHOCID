<?xml version="1.0" encoding="UTF-8" ?> <%@ page
		...
		import="shocid.hoann.StartJSP"%> <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
        "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<!-- TemplateBeginEditable name="doctitle" -->
<title>Genetic Classification</title>
<!-- TemplateEndEditable -->
<style type="text/css">
body,td,th {
...
<body>
	<h3>Genetic data processing</h3>
	<p>Shall the task be processed with a single agent or a democratic
		committee of agents?</p>
	<form id="form1" name="form1" method="post" action="../start.jsp">
		<label for="agents"></label> <select name="agents" size="1"
			id="agents">
		...
		<label for="outputNeurons"></label> <input type="text"
			name="outputNeurons" id="outputNeurons" /> <span id="form1">
			<input name="trainingMethod" type="hidden" id="trainingMethod"
			value="g" /> </span> <span id="form1"> <input name="networkType"
			type="hidden" id="networkType" value="1" /> </span> <input type="submit"
			name="execute" id="execute" value="Execute" />
	</form>
	<!-- TemplateBeginIf cond="normalization==1" -->OptionalRegion1<!-- TemplateEndIf -->
</body>
	</html>