		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<%
					...
					if (FFANNAdaptiveLevenbergMarquardtJSP.getBestSHLNetworkQuality() < FFANNAdaptiveLevenbergMarquardtJSP
							.getBestMHLNetworkQuality()) {
						bestNetwork = FFANNAdaptiveLevenbergMarquardtJSP
				...
				<p>
					<%
						if (FFANNAdaptiveLevenbergMarquardtJSP.getBestSHLNetworkQuality() < FFANNAdaptiveLevenbergMarquardtJSP
								.getBestMHLNetworkQuality()) {
							hn1 = FFANNAdaptiveLevenbergMarquardtJSP
					...
					<%
							...
							hn1 = FFANNAdaptiveLevenbergMarquardtJSP
									.getBestHiddenLayer1Neurons();
							hn2 = FFANNAdaptiveLevenbergMarquardtJSP
					...
					<%
						...
						bestEpochs = FFANNAdaptiveLevenbergMarquardtJSP.getBestEpochs();
					%>
				...
				<table border=0 width=100%>
					<%
						...
						int epochsSHL = 0;
						for (int i = 0; i < FFANNAdaptiveLevenbergMarquardtJSP
								.getQualitySHLArray().length; i++) {
							qualitySHL = FFANNAdaptiveLevenbergMarquardtJSP
									.getQualitySHLArray(i);
							epochsSHL = FFANNAdaptiveLevenbergMarquardtJSP.getEpochsSL(i);
					%>
					<tr>
				...
				<table border=0 width=100%>
					<%
						...
						for (int i = 0; i < FFANNAdaptiveLevenbergMarquardtJSP
							...
							qualityMHL = FFANNAdaptiveLevenbergMarquardtJSP
									.getQualityMHLArray(i);
							epochsMHL = FFANNAdaptiveLevenbergMarquardtJSP.getEpochsML(i);
					%>
					<tr>
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<form id="form1" name="form1" method="post"
					action="lmaAdaptiveSingleDetails.jsp">
					<table>
						<tr>
							<td>
								<div id="SHLAgentDetails">
									<label for="SHLAgentDetails">SHL agent evolution
										...
										name="showSHLAgentDetails" size="1" id="showSHLAgentDetails">
											<%
												for (int networks = 0; networks < FFANNAdaptiveLevenbergMarquardtJSP
