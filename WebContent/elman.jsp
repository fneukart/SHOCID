...
<body>
	<h3>Elman data processing</h3>
	<p>Shall the task be processed with a single agent or a democratic
		committee of agents?</p>

	<form id="form1" name="form1" method="post" action="elmanMiddler.jsp">
...
<h3>File attributes</h3>
		...
		<label for="allowedError"></label> <input type="text"
			...
			name="trainingMethod" type="hidden" id="trainingMethod" value="elman" />
		</span> <span id="form1"> <input name="networkType" type="hidden"
			id="networkType" value="2" /> </span> <input type="submit" name="execute"
