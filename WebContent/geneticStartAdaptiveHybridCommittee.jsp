...
<title>Genetic Data Processing</title>
<link href="SpryAssets/SpryAccordion.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<h1 class="heading">Genetic classification results</h1>
	...
	<%
            ...
            int numberInputNeurons = GeneticAlgorithmHCJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = GeneticAlgorithmHCJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = GeneticAlgorithmHCJSP
            ...
            int col = 0;
            double[][] inputValuesArray = GeneticAlgorithmHCJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = GeneticAlgorithmHCJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = GeneticAlgorithmHCJSP.getAverageExpertValuesGUI();
            ...
            switch(numberAgents)
                {
                case 1:
                    agent1Errors = GeneticAlgorithmHCJSP.getAgentErrors(1);
                    
                    agent1Epochs = AdaptiveHybridHOANNCommitteeJSP.getExpertEpochs(1);
                    break;
                case 2:
                    agent1Errors = GeneticAlgorithmHCJSP.getAgentErrors(1);
                    agent2Errors = GeneticAlgorithmHCJSP.getAgentErrors(2);
                ...
                case 3:
                    agent1Errors = GeneticAlgorithmHCJSP.getAgentErrors(1);
                    agent2Errors = GeneticAlgorithmHCJSP.getAgentErrors(2);
                    agent3Errors = GeneticAlgorithmHCJSP.getAgentErrors(3);
                ...
                case 4:
                    ...
                    agent2Errors = GeneticAlgorithmHCJSP.getAgentErrors(2);
                    agent3Errors = GeneticAlgorithmHCJSP.getAgentErrors(3);
                    agent4Errors = GeneticAlgorithmHCJSP.getAgentErrors(4);
                ...
                case 5:
                    ...
                    agent3Errors = GeneticAlgorithmHCJSP.getAgentErrors(3);
                    agent4Errors = GeneticAlgorithmHCJSP.getAgentErrors(4);
                    agent5Errors = GeneticAlgorithmHCJSP.getAgentErrors(5);
            ...
            double[][] idealValuesArray = GeneticAlgorithmHCJSP
                    .getIdealValues();
            int epochs = GeneticAlgorithmHCJSP.getEpochs();
    %>

	<div id="AccordionCommittee" class="Accordion">
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Error over generations - graphs
				per genetic agent</div>
			<div class="AccordionPanelContent">
                ...
                //Agent 1 Graph
                    //Graph
                        ...
                        strXMLA1 = "<graph caption='Error over generations - genetic agent 1' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 2 Graph
                 //Graph
                     ...
                     int a2 = 0;
                     //Initialize graph element
                     strXMLA2 = "<graph caption='Error over generations - genetic agent 2' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 3 Graph
                 //Graph
                     ...
                     int a3 = 0;
                     //Initialize graph element
                     strXMLA3 = "<graph caption='Error over generations - genetic agent 3' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 4 Graph
                 //Graph
                     ...
                     int a4 = 0;
                     //Initialize graph element
                     strXMLA4 = "<graph caption='Error over generations - genetic agent 4' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 5 Graph
                 //Graph
                     ...
                     int a5 = 0;
                     //Initialize graph element
                     strXMLA5 = "<graph caption='Error over generations - genetic agent 5' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<table border=1>
					<tr>
						<th><h3>
								Genetic agent 1 needed to evolve
						...
						<%if (numberAgents >= 2)
                               {%>
						<th><h3>
								Genetic agent 2 needed to evolve
						...
						<%if (numberAgents >= 3)
                               {%>
						<th><h3>
								Genetic agent 3 needed to evolve
						...
						<%if (numberAgents >= 4)
                               {%>
						<th><h3>
								Genetic agent 4 needed to evolve
						...
						<%if (numberAgents == 5)
                               {%>
						<th><h3>
								Genetic agent 5 needed to evolve
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<h3>Neural genetic committee agent 1:</h3>
				<table border=5>
					<%
        ...
        {
            %>
				<h3>Neural genetic committee agent 2:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural genetic committee agent 3:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural genetic committee agent 4:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural genetic committee agent 5:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<%
                    ...
                    if (FFANNHybridAdaptiveGeneticAlgorithmJSP.getBestSHLNetworkQuality() < FFANNHybridAdaptiveGeneticAlgorithmJSP
                            .getBestMHLNetworkQuality()) {
                        bestNetwork = FFANNHybridAdaptiveGeneticAlgorithmJSP
				...
				<p>
					<%
                        if (FFANNHybridAdaptiveGeneticAlgorithmJSP.getBestSHLNetworkQuality() < FFANNHybridAdaptiveGeneticAlgorithmJSP
                                .getBestMHLNetworkQuality()) {
                            hn1 = FFANNHybridAdaptiveGeneticAlgorithmJSP
					...
					<%
                            ...
                            hn1 = FFANNHybridAdaptiveGeneticAlgorithmJSP
                                    .getBestHiddenLayer1Neurons();
                            hn2 = FFANNHybridAdaptiveGeneticAlgorithmJSP
					...
					<%
                        ...
                        bestEpochs = FFANNHybridAdaptiveGeneticAlgorithmJSP.getBestEpochs();
                    %>
				...
				<table border=0 width=100%>
					<%
                        ...
                        int epochsSHL = 0;
                        for (int i = 0; i < FFANNHybridAdaptiveGeneticAlgorithmJSP
                                .getQualitySHLArray().length; i++) {
                            qualitySHL = FFANNHybridAdaptiveGeneticAlgorithmJSP
                                    .getQualitySHLArray(i);
                            epochsSHL = FFANNHybridAdaptiveGeneticAlgorithmJSP.getEpochsSL(i);
                    %>
					<tr>
				...
				<table border=0 width=100%>
					<%
                        ...
                        for (int i = 0; i < FFANNHybridAdaptiveGeneticAlgorithmJSP
                            ...
                            qualityMHL = FFANNHybridAdaptiveGeneticAlgorithmJSP
                                    .getQualityMHLArray(i);
                            epochsMHL = FFANNHybridAdaptiveGeneticAlgorithmJSP.getEpochsML(i);
                    %>
					<tr>
		...
		<h3>Neural genetic committee has automatically been saved
