...
//  			String inputFilePath = "C:\\Users\\Florian Neukart\\workspace\\SHOCID_310\\"
  //					+ request.getParameter("input");
	...
	<div id="AccordionSingle" class="Accordion">
		<%
			int numberInputNeurons = FFANNSimulatedAnnealingJSP
					.getNumberInputNeurons();
        int numberOutputNeurons = Integer
        .valueOf(numberOutputNeuronsString).intValue();
			MLDataSet trainingSet = FFANNSimulatedAnnealingJSP
					.getTrainingSet();
			BasicNetwork network = FFANNSimulatedAnnealingJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNSimulatedAnnealingJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNSimulatedAnnealingJSP
					.getOutputValues();
			double[][] idealValuesArray = FFANNSimulatedAnnealingJSP
					.getIdealValues();
			double[] error = FFANNSimulatedAnnealingJSP.getError();
			int epochs = FFANNSimulatedAnnealingJSP.getEpochs();
		%>
