...
<%@ page
	import="shocid.elman.application.ElmanCApplicationJSP"%>
...
<body>
	...
	<%
            ...
            int numberAgents = ElmanCApplicationJSP.getNumberCommitteeMembers();

            int numberInputNeurons = ElmanCApplicationJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = ElmanCApplicationJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = ElmanCApplicationJSP
                    .getCommitteeTrainingSet();
            int col = 0;
            double[][] inputValuesArray = ElmanCApplicationJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = ElmanCApplicationJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = ElmanCApplicationJSP.getAverageExpertValuesGUI();
    %>
	...
	<div id="AccordionCommittee" class="Accordion">
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<h3>Neural Elman committee agent 1:</h3>
				<table border=5>
					<%
        ...
        {
            %>
				<h3>Neural Elman committee agent 2:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural Elman committee agent 3:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural Elman committee agent 4:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural Elman committee agent 5:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
