...
<%@ page import="shocid.ffann.training.adaptive.FFANNAdaptiveSimulatedAnnealingJSP"%>
...
<title>Adaptive Simulated Annealing Data Processing</title>
<link href="SpryAssets/SpryAccordion.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<h1 class="heading">Adaptive simulated annealing classification
		results</h1>
	...
	<div id="AccordionSingle" class="Accordion">
		<%
			int numberInputNeurons = FFANNAdaptiveSimulatedAnnealingJSP
					.getNumberInputNeurons();
		int numberOutputNeurons = Integer.valueOf(numberOutputNeuronsString).intValue();
			MLDataSet trainingSet = FFANNAdaptiveSimulatedAnnealingJSP
					.getTrainingSet();
			BasicNetwork network = FFANNAdaptiveSimulatedAnnealingJSP
					.getBestNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNAdaptiveSimulatedAnnealingJSP
					.getInputValues(0);
			double[][] outputValuesArray = FFANNAdaptiveSimulatedAnnealingJSP
					.getOutputValuesBestOverall();
			double[][] idealValuesArray = FFANNAdaptiveSimulatedAnnealingJSP
					.getIdealValues(0);
			double[] error = FFANNAdaptiveSimulatedAnnealingJSP
					.getErrorBestNetwork();
			double[] errorSelected;
			int epochs = FFANNAdaptiveSimulatedAnnealingJSP.getBestEpochs();
		%>
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Error over iterations - graph of
				simulated annealing agent</div>
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<%
					...
					if (FFANNAdaptiveSimulatedAnnealingJSP.getBestSHLNetworkQuality() < FFANNAdaptiveSimulatedAnnealingJSP
							.getBestMHLNetworkQuality()) {
						bestNetwork = FFANNAdaptiveSimulatedAnnealingJSP
				...
				<p>
					<%
						if (FFANNAdaptiveSimulatedAnnealingJSP.getBestSHLNetworkQuality() < FFANNAdaptiveSimulatedAnnealingJSP
								.getBestMHLNetworkQuality()) {
							hn1 = FFANNAdaptiveSimulatedAnnealingJSP
					...
					<%
							...
							hn1 = FFANNAdaptiveSimulatedAnnealingJSP
									.getBestHiddenLayer1Neurons();
							hn2 = FFANNAdaptiveSimulatedAnnealingJSP
					...
					<%
						...
						bestEpochs = FFANNAdaptiveSimulatedAnnealingJSP.getBestEpochs();
					%>
				...
				<table border=0 width=100%>
					<%
						...
						int epochsSHL = 0;
						for (int i = 0; i < FFANNAdaptiveSimulatedAnnealingJSP
								.getQualitySHLArray().length; i++) {
							qualitySHL = FFANNAdaptiveSimulatedAnnealingJSP
									.getQualitySHLArray(i);
							epochsSHL = FFANNAdaptiveSimulatedAnnealingJSP.getEpochsSL(i);
					%>
					<tr>
				...
				<table border=0 width=100%>
					<%
						...
						for (int i = 0; i < FFANNAdaptiveSimulatedAnnealingJSP
							...
							qualityMHL = FFANNAdaptiveSimulatedAnnealingJSP
									.getQualityMHLArray(i);
							epochsMHL = FFANNAdaptiveSimulatedAnnealingJSP.getEpochsML(i);
					%>
					<tr>
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<form id="form1" name="form1" method="post"
					action="simulatedAdaptiveSingleDetails.jsp">
					<table>
						<tr>
							<td>
								<div id="SHLAgentDetails">
									<label for="SHLAgentDetails">SHL agent evolution
										...
										name="showSHLAgentDetails" size="1" id="showSHLAgentDetails">
											<%
												for (int networks = 0; networks < FFANNAdaptiveSimulatedAnnealingJSP
