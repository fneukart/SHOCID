...
<%@ page import="shocid.jordan.JordanJSP"%>
...
<body>
	...
	<div id="AccordionSingle" class="Accordion">
		<%
			int numberInputNeurons = JordanJSP
					.getNumberInputNeurons();
        int numberOutputNeurons = Integer
        .valueOf(numberOutputNeuronsString).intValue();
			MLDataSet trainingSet = JordanJSP
					.getTrainingSet();
			BasicNetwork network = JordanJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = JordanJSP
					.getInputValues();
			double[][] outputValuesArray = JordanJSP
					.getOutputValues();
			double[][] idealValuesArray = JordanJSP
					.getIdealValues();
			double[] error = JordanJSP.getError();
			int epochs = JordanJSP.getEpochs();
		%>
