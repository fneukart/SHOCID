...
<body>
	<h3>Genetic value imputation</h3>

	<form id="form1" name="form1" method="post" action="imputationMiddler.jsp">
...
<h3>File attributes</h3>
        ...
        <p>Select the input file to be imputed:</p>
        <label for="input"></label> <input type="file" name="input" id="input"
            size="50" maxlength="100000" accept="text/*" />
        
        <p>Enter the numbers of the columns that influence the missing column (e.g.: 1,2)</p>

        <label for="inputNeurons"></label> <input type="text"
            name="inputNeurons" id="inputNeurons" />
            
                    <p>Enter the number of the column to impute</p>

        <label for="imputationColumn"></label> <input type="text"
            name="imputationColumn" id="imputationColumn" />
		...
		<label for="allowedError"></label> <input type="text"
			...
			name="trainingMethod" type="hidden" id="trainingMethod" value="imputation" />
