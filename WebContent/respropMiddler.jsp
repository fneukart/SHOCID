...
<title>Resilient Propagation Processing</title>
...
<body>
    ...
    %>
    <jsp:forward page="respropStartSingle.jsp" />
    <%
        } else if (committee_or_single.equals("es")) {
    %>
    <jsp:forward page="respropStartAdaptiveSingle.jsp" />
    <%
        } else if (committee_or_single.equals("c")) {
    %>
    <jsp:forward page="respropStartCommittee.jsp" />
    <%
        }
    %>
