...
<%@ page import="shocid.ffann.committee.training.RadialBasisCJSP"%>
<%@ page import="shocid.saveFile.ApplyFileDialog"%>
<%@ page import="org.encog.ml.data.MLDataSet"%>
<%@ page import="org.encog.neural.rbf.RBFNetwork"%>
...
<title>Radial Basis Function with RPROP Data Processing</title>
<link href="SpryAssets/SpryAccordion.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<h1 class="heading">Radial Basis Function with RPROP
		classification results</h1>
	...
	<%
            ...
            int numberInputNeurons = RadialBasisCJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = RadialBasisCJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = RadialBasisCJSP
                    .getCommitteeTrainingSet();
            RBFNetwork[] trainedCommittee = HOANNCommitteeJSP
                    .getTrainedCommitteeRBF();
            String[] trainedCommitteeNames = HOANNCommitteeJSP.getTrainedCommitteeMemberNames();
            int col = 0;
            double[][] inputValuesArray = RadialBasisCJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = RadialBasisCJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = RadialBasisCJSP.getAverageExpertValuesGUI();
            ...
            switch(numberAgents)
                {
                case 1:
                    agent1Errors = RadialBasisCJSP.getAgentErrors(1);
                    
                    agent1Epochs = HOANNCommitteeJSP.getExpertEpochs(1);
                    break;
                case 2:
                    agent1Errors = RadialBasisCJSP.getAgentErrors(1);
                    agent2Errors = RadialBasisCJSP.getAgentErrors(2);
                ...
                case 3:
                    agent1Errors = RadialBasisCJSP.getAgentErrors(1);
                    agent2Errors = RadialBasisCJSP.getAgentErrors(2);
                    agent3Errors = RadialBasisCJSP.getAgentErrors(3);
                ...
                case 4:
                    ...
                    agent2Errors = RadialBasisCJSP.getAgentErrors(2);
                    agent3Errors = RadialBasisCJSP.getAgentErrors(3);
                    agent4Errors = RadialBasisCJSP.getAgentErrors(4);
                ...
                case 5:
                    ...
                    agent3Errors = RadialBasisCJSP.getAgentErrors(3);
                    agent4Errors = RadialBasisCJSP.getAgentErrors(4);
                    agent5Errors = RadialBasisCJSP.getAgentErrors(5);
            ...
            double[][] idealValuesArray = RadialBasisCJSP
                    .getIdealValues();
            int epochs = RadialBasisCJSP.getEpochs();
    %>
	...
	<div id="AccordionCommittee" class="Accordion">
			...
			<div class="AccordionPanelContent">
                ...
                //Agent 1 Graph
                    //Graph
                        ...
                        strXMLA1 = "<graph caption='Error over generations - RBF agent 1' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 2 Graph
                 //Graph
                     ...
                     int a2 = 0;
                     //Initialize graph element
                     strXMLA2 = "<graph caption='Error over generations - RBF agent 2' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 3 Graph
                 //Graph
                     ...
                     int a3 = 0;
                     //Initialize graph element
                     strXMLA3 = "<graph caption='Error over generations - RBF agent 3' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 4 Graph
                 //Graph
                     ...
                     int a4 = 0;
                     //Initialize graph element
                     strXMLA4 = "<graph caption='Error over generations - RBF agent 4' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 5 Graph
                 //Graph
                     ...
                     int a5 = 0;
                     //Initialize graph element
                     strXMLA5 = "<graph caption='Error over generations - RBF agent 5' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
		...
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Neuron outputs per RBF agent</div>
			<div class="AccordionPanelContent">
				<h3>Neural RBF committee agent 1:</h3>
				<table border=5>
					<%
        ...
        {
            %>
				<h3>Neural RBF committee agent 2:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural RBF committee agent 3:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural RBF committee agent 4:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural RBF committee agent 5:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
		...
		<h3>Neural RBF committee has automatically been saved under
							SHOCID\committees</h3>
