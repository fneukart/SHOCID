...
<%@ page import="shocid.ffann.application.FFANNBackPropagationApplicationJSP"%>
...
//					+ request.getParameter("output");
			...
			MLDataSet trainingSet = FFANNBackPropagationApplicationJSP.getTrainingSet();
			BasicNetwork network = FFANNBackPropagationApplicationJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNBackPropagationApplicationJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNBackPropagationApplicationJSP
					.getOutputValues();
		%>
