...
<%@ page import="shocid.ffann.application.FFANNRadialBasisFunctionApplicationJSP"%>
...
<body>
	<h1 class="heading">Radial Basis Function with RPROP classification results</h1>
		...
		<%
			...
			MLDataSet trainingSet = FFANNRadialBasisFunctionApplicationJSP.getTrainingSet();
			RBFNetwork network = FFANNRadialBasisFunctionApplicationJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNRadialBasisFunctionApplicationJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNRadialBasisFunctionApplicationJSP
					.getOutputValues();
		%>
