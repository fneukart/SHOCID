...
<%@ page import="shocid.ffann.training.FFANNRadialBasisFunctionJSP"%>
...
<body>
	...
	<div id="AccordionSingle" class="Accordion">
		<%
			int numberInputNeurons = FFANNRadialBasisFunctionJSP
					.getNumberInputNeurons();
        int numberOutputNeurons = Integer
        .valueOf(numberOutputNeuronsString).intValue();
			MLDataSet trainingSet = FFANNRadialBasisFunctionJSP
					.getTrainingSet();
			RBFNetwork network = FFANNRadialBasisFunctionJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNRadialBasisFunctionJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNRadialBasisFunctionJSP
					.getOutputValues();
			double[][] idealValuesArray = FFANNRadialBasisFunctionJSP
					.getIdealValues();
			double[] error = FFANNRadialBasisFunctionJSP.getError();
			int epochs = FFANNRadialBasisFunctionJSP.getEpochs();
		%>
