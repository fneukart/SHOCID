...
//                    + request.getParameter("output");
            ...
            int numberInputNeurons = GeneticAlgorithmCJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = GeneticAlgorithmCJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = GeneticAlgorithmCJSP
            ...
            int col = 0;
            double[][] inputValuesArray = GeneticAlgorithmCJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = GeneticAlgorithmCJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = GeneticAlgorithmCJSP.getAverageExpertValuesGUI();
            ...
            switch(numberAgents)
                {
                case 1:
                    agent1Errors = GeneticAlgorithmCJSP.getAgentErrors(1);
                    
                    agent1Epochs = HOANNCommitteeJSP.getExpertEpochs(1);
                    break;
                case 2:
                    agent1Errors = GeneticAlgorithmCJSP.getAgentErrors(1);
                    agent2Errors = GeneticAlgorithmCJSP.getAgentErrors(2);
                ...
                case 3:
                    agent1Errors = GeneticAlgorithmCJSP.getAgentErrors(1);
                    agent2Errors = GeneticAlgorithmCJSP.getAgentErrors(2);
                    agent3Errors = GeneticAlgorithmCJSP.getAgentErrors(3);
                ...
                case 4:
                    ...
                    agent2Errors = GeneticAlgorithmCJSP.getAgentErrors(2);
                    agent3Errors = GeneticAlgorithmCJSP.getAgentErrors(3);
                    agent4Errors = GeneticAlgorithmCJSP.getAgentErrors(4);
                ...
                case 5:
                    ...
                    agent3Errors = GeneticAlgorithmCJSP.getAgentErrors(3);
                    agent4Errors = GeneticAlgorithmCJSP.getAgentErrors(4);
                    agent5Errors = GeneticAlgorithmCJSP.getAgentErrors(5);
            ...
            double[][] idealValuesArray = GeneticAlgorithmCJSP
                    .getIdealValues();
            int epochs = GeneticAlgorithmCJSP.getEpochs();
    %>
