...
<body>
	<h3>SOFM data processing</h3>
	<form id="form1" name="form1" method="post" action="sofmMiddler.jsp">
...
<h3>File attributes</h3>
        ...
        <p>How many output clusters shall the result contain?</p>
		...
		<label for="allowedError"></label> <input type="text"
			...
			name="trainingMethod" type="hidden" id="trainingMethod" value="sofm" />
