...
<body>
	...
	<div id="AccordionSingle" class="Accordion">
		<%
			int numberInputNeurons = FFANNLevenbergMarquardtJSP
					.getNumberInputNeurons();
        int numberOutputNeurons = Integer
        .valueOf(numberOutputNeuronsString).intValue();
			MLDataSet trainingSet = FFANNLevenbergMarquardtJSP
					.getTrainingSet();
			BasicNetwork network = FFANNLevenbergMarquardtJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNLevenbergMarquardtJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNLevenbergMarquardtJSP
					.getOutputValues();
			double[][] idealValuesArray = FFANNLevenbergMarquardtJSP
					.getIdealValues();
			double[] error = FFANNLevenbergMarquardtJSP.getError();
			int epochs = FFANNLevenbergMarquardtJSP.getEpochs();
		%>
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Error over iterations - graph
				of Levenberg Marquardt agent</div>
