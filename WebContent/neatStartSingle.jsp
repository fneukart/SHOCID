...
<%@ page import="shocid.neatpopulation.NEATPopulationJSP"%>
...
<body>
	...
	<div id="AccordionSingle" class="Accordion">
		<%
			int numberInputNeurons = NEATPopulationJSP
					.getNumberInputNeurons();
        int numberOutputNeurons = Integer
        .valueOf(numberOutputNeuronsString).intValue();
			MLDataSet trainingSet = NEATPopulationJSP
					.getTrainingSet();
			BasicNetwork network = NEATPopulationJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = NEATPopulationJSP
					.getInputValues();
			double[][] outputValuesArray = NEATPopulationJSP
					.getOutputValues();
			double[][] idealValuesArray = NEATPopulationJSP
					.getIdealValues();
			double[] error = NEATPopulationJSP.getError();
			int epochs = NEATPopulationJSP.getEpochs();
		%>
