...
<title>Adaptive Manhattan Update Data Processing</title>
<link href="SpryAssets/SpryAccordion.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<h1 class="heading">Adaptive manhatttan update classification
		results</h1>
	...
	<div id="AccordionSingle" class="Accordion">
		...
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Error over iterations - graph of
				SHL mahnattan update agent</div>
			<div class="AccordionPanelContent">
				...
				<%
					...
					if (FFANNAdaptiveManhattanUpdateJSP.getErrorsSL(SHLAgentNumber).length > 500) {
						errorSelected = new double[500];
						jump = Math.round(FFANNAdaptiveManhattanUpdateJSP
								.getErrorsSL(SHLAgentNumber).length / 500);

						for (int i = 0; i < 500; i++) {
							errorSelected[i] = FFANNAdaptiveManhattanUpdateJSP
									.getErrorsSL(SHLAgentNumber)[position];
							position = position + jump;
						}
					} else {
						errorSelected = FFANNAdaptiveManhattanUpdateJSP
			...
			<div class="AccordionPanelTab">Error over iterations - graph of
				MHL mahnattan update agent</div>
			<div class="AccordionPanelContent">
				...
				<%
					...
					if (FFANNAdaptiveManhattanUpdateJSP.getErrorsML(MHLAgentNumber).length > 500) {
						errorSelected = new double[500];
						jump = Math.round(FFANNAdaptiveManhattanUpdateJSP
