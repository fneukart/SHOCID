...
<%@ page import="shocid.ffann.application.FFANNSimulatedAnnealingApplicationJSP"%>
...
// 					+ request.getParameter("output");
			...
			MLDataSet trainingSet = FFANNSimulatedAnnealingApplicationJSP.getTrainingSet();
			BasicNetwork network = FFANNSimulatedAnnealingApplicationJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNSimulatedAnnealingApplicationJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNSimulatedAnnealingApplicationJSP
					.getOutputValues();
		%>
