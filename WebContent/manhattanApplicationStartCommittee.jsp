...
<%@ page
	import="shocid.ffann.committee.application.ManhattanUpdateCApplicationJSP"%>
...
<title>Manhattan Update Rule Data Processing</title>
<link href="SpryAssets/SpryAccordion.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<h1 class="heading">Manhattan Update Rule classification results</h1>
	...
	<%
            ...
            int numberAgents = ManhattanUpdateCApplicationJSP.getNumberCommitteeMembers();

            int numberInputNeurons = ManhattanUpdateCApplicationJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = ManhattanUpdateCApplicationJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = ManhattanUpdateCApplicationJSP
                    .getCommitteeTrainingSet();
            int col = 0;
            double[][] inputValuesArray = ManhattanUpdateCApplicationJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = ManhattanUpdateCApplicationJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = ManhattanUpdateCApplicationJSP.getAverageExpertValuesGUI();
    %>

	<div id="AccordionCommittee" class="Accordion">
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Neuron outputs per Manhattan Update Rule agent</div>
			<div class="AccordionPanelContent">
				<h3>Neural Manhattan Update Rule propagation committee agent 1:</h3>
				<table border=5>
					<%
        ...
        {
            %>
				<h3>Neural Manhattan Update Rule committee agent 2:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural Manhattan Update Rule committee agent 3:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural Manhattan Update Rule committee agent 4:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural Manhattan Update Rule committee agent 5:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
