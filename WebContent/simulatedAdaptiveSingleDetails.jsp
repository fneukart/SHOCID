	...
	<div id="AccordionSingle" class="Accordion">
		...
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Error over iterations - graph of
				SHL simulated annealing agent</div>
			<div class="AccordionPanelContent">
				...
				<%
					...
					if (FFANNAdaptiveSimulatedAnnealingJSP.getErrorsSL(SHLAgentNumber).length > 500) {
						errorSelected = new double[500];
						jump = Math.round(FFANNAdaptiveSimulatedAnnealingJSP
								.getErrorsSL(SHLAgentNumber).length / 500);

						for (int i = 0; i < 500; i++) {
							errorSelected[i] = FFANNAdaptiveSimulatedAnnealingJSP
									.getErrorsSL(SHLAgentNumber)[position];
							position = position + jump;
						}
					} else {
						errorSelected = FFANNAdaptiveSimulatedAnnealingJSP
			...
			<div class="AccordionPanelTab">Error over iterations - graph of
				MHL simulated annealing agent</div>
			<div class="AccordionPanelContent">
				...
				<%
					...
					if (FFANNAdaptiveSimulatedAnnealingJSP.getErrorsML(MHLAgentNumber).length > 500) {
						errorSelected = new double[500];
						jump = Math.round(FFANNAdaptiveSimulatedAnnealingJSP
