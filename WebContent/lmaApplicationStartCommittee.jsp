...
<%@ page
	import="shocid.ffann.committee.application.LevenbergMarquardtCApplicationJSP"%>
...
<body>
	...
	<%
            ...
            int numberAgents = LevenbergMarquardtCApplicationJSP.getNumberCommitteeMembers();

            int numberInputNeurons = LevenbergMarquardtCApplicationJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = LevenbergMarquardtCApplicationJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = LevenbergMarquardtCApplicationJSP
                    .getCommitteeTrainingSet();
            int col = 0;
            double[][] inputValuesArray = LevenbergMarquardtCApplicationJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = LevenbergMarquardtCApplicationJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = LevenbergMarquardtCApplicationJSP.getAverageExpertValuesGUI();
    %>

	<div id="AccordionCommittee" class="Accordion">
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Neuron outputs per Levenberg Marquardt agent</div>
			<div class="AccordionPanelContent">
				<h3>Neural Levenberg Marquardt propagation committee agent 1:</h3>
				<table border=5>
					<%
