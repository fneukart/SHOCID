...
<title>Quantum ANN Simulation Classification</title>
<style type="text/css">
body,td,th {
...
<h3>File attributes</h3>
		...
		<label for="allowedError"></label> <input type="text"
			...
			name="trainingMethod" type="hidden" id="trainingMethod" value="quantum" />
		</span> <span id="form1"> <input name="networkType" type="hidden"
			id="networkType" value="5" /> </span> <input type="submit" name="execute"
