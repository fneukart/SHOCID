...
<title>NEAT Classification</title>
<style type="text/css">
body,td,th {
...
<h3>File attributes</h3>
        ...
        <label for="allowedError"></label> <input type="text"
            name="allowedError" id="allowedError" />
			
			<span id="form1">
			<input name="trainingMethod" type="hidden" id="trainingMethod"
			value="neat" /> </span> <span id="form1"> <input name="networkType"
			type="hidden" id="networkType" value="3" /> </span> <input type="submit"
