...
<%@ page import="shocid.ffann.application.FFANNResilientPropagationApplicationJSP"%>
...
<body>
	<h1 class="heading">Resilient propagation classification results</h1>
		...
		<%
			...
			MLDataSet trainingSet = FFANNResilientPropagationApplicationJSP.getTrainingSet();
			BasicNetwork network = FFANNResilientPropagationApplicationJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNResilientPropagationApplicationJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNResilientPropagationApplicationJSP
					.getOutputValues();
		%>
