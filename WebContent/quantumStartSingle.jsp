...
<%@ page import="shocid.quantum.FFANNQuantumSimulatedAnnealingJSP"%>
...
<title>Quantum Data Processing</title>
<link href="SpryAssets/SpryAccordion.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<h1 class="heading">Quantum classification results</h1>
...
//  			String inputFilePath = "C:\\Users\\Florian Neukart\\workspace\\SHOCID_310\\"
  //					+ request.getParameter("input");
 	...
 	<div id="AccordionSingle" class="Accordion">
		<%
			int numberInputNeurons = FFANNQuantumSimulatedAnnealingJSP
					.getNumberInputNeurons();
        int numberOutputNeurons = Integer
        .valueOf(numberOutputNeuronsString).intValue();
			MLDataSet trainingSet = FFANNQuantumSimulatedAnnealingJSP
					.getTrainingSet();
			BasicNetwork network = FFANNQuantumSimulatedAnnealingJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNQuantumSimulatedAnnealingJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNQuantumSimulatedAnnealingJSP
					.getOutputValues();
			double[][] idealValuesArray = FFANNQuantumSimulatedAnnealingJSP
					.getIdealValues();
			double[] error = FFANNQuantumSimulatedAnnealingJSP.getError();
			int epochs = FFANNQuantumSimulatedAnnealingJSP.getEpochs();
		%>
