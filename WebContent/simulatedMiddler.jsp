...
<body>
    ...
    %>
    <jsp:forward page="simulatedStartSingle.jsp" />
    <%
        } else if (committee_or_single.equals("es")) {
    %>
    <jsp:forward page="simulatedStartAdaptiveSingle.jsp" />
    <%
        } else if (committee_or_single.equals("c")) {
    %>
    <jsp:forward page="simulatedStartCommittee.jsp" />
        <%
        } else if (committee_or_single.equals("ec")) {
    %>
    <jsp:forward page="simulatedStartAdaptiveHybridCommittee.jsp" />
    <%
        }
    %>
