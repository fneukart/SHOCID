...
<%@ page import="shocid.transgenetic.hostgeneticinformation.FFANNTransGeneticAlgorithmJSP"%>
...
<title>Transgenetic Data Processing</title>
<link href="SpryAssets/SpryAccordion.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<h1 class="heading">Transgenetic classification results</h1>
...
//  					+ request.getParameter("output");
	...
	<div id="AccordionSingle" class="Accordion">
		<%
			int numberInputNeurons = FFANNTransGeneticAlgorithmJSP
					.getNumberInputNeurons();
        int numberOutputNeurons = Integer
        .valueOf(numberOutputNeuronsString).intValue();
			MLDataSet trainingSet = FFANNTransGeneticAlgorithmJSP
					.getTrainingSet();
			BasicNetwork network = FFANNTransGeneticAlgorithmJSP.getTGNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNTransGeneticAlgorithmJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNTransGeneticAlgorithmJSP
					.getOutputValues();
			double[][] idealValuesArray = FFANNTransGeneticAlgorithmJSP
					.getIdealValues();
			double[] error = FFANNTransGeneticAlgorithmJSP.getTGError();
			int epochs = FFANNTransGeneticAlgorithmJSP.getTGEpochs();
		%>
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Error over generations - graph
				of transgenetic agent</div>
