...
<title>Resilient Propagation Data Processing</title>
<link href="SpryAssets/SpryAccordion.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<h1 class="heading">Resilient Propagation classification results</h1>
	...
	<%
            ...
            int numberInputNeurons = ResilientPropagationCJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = ResilientPropagationCJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = ResilientPropagationCJSP
            ...
            int col = 0;
            double[][] inputValuesArray = ResilientPropagationCJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = ResilientPropagationCJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = ResilientPropagationCJSP.getAverageExpertValuesGUI();
            ...
            switch(numberAgents)
                {
                case 1:
                    agent1Errors = ResilientPropagationCJSP.getAgentErrors(1);
                    
                    agent1Epochs = HOANNCommitteeJSP.getExpertEpochs(1);
                    break;
                case 2:
                    agent1Errors = ResilientPropagationCJSP.getAgentErrors(1);
                    agent2Errors = ResilientPropagationCJSP.getAgentErrors(2);
                ...
                case 3:
                    agent1Errors = ResilientPropagationCJSP.getAgentErrors(1);
                    agent2Errors = ResilientPropagationCJSP.getAgentErrors(2);
                    agent3Errors = ResilientPropagationCJSP.getAgentErrors(3);
                ...
                case 4:
                    ...
                    agent2Errors = ResilientPropagationCJSP.getAgentErrors(2);
                    agent3Errors = ResilientPropagationCJSP.getAgentErrors(3);
                    agent4Errors = ResilientPropagationCJSP.getAgentErrors(4);
                ...
                case 5:
                    ...
                    agent3Errors = ResilientPropagationCJSP.getAgentErrors(3);
                    agent4Errors = ResilientPropagationCJSP.getAgentErrors(4);
                    agent5Errors = ResilientPropagationCJSP.getAgentErrors(5);
            ...
            double[][] idealValuesArray = ResilientPropagationCJSP
                    .getIdealValues();
            int epochs = ResilientPropagationCJSP.getEpochs();
    %>

	<div id="AccordionCommittee" class="Accordion">
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Error over iterations - graphs
				per resilient propagation agent</div>
			<div class="AccordionPanelContent">
                ...
                //Agent 1 Graph
                    //Graph
                        ...
                        strXMLA1 = "<graph caption='Error over iterations - resilient propagation agent 1' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 2 Graph
                 //Graph
                     ...
                     int a2 = 0;
                     //Initialize graph element
                     strXMLA2 = "<graph caption='Error over iterations - resilient propagation agent 2' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 3 Graph
                 //Graph
                     ...
                     int a3 = 0;
                     //Initialize graph element
                     strXMLA3 = "<graph caption='Error over iterations - resilient propagation agent 3' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 4 Graph
                 //Graph
                     ...
                     int a4 = 0;
                     //Initialize graph element
                     strXMLA4 = "<graph caption='Error over iterations - resilient propagation agent 4' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 5 Graph
                 //Graph
                     ...
                     int a5 = 0;
                     //Initialize graph element
                     strXMLA5 = "<graph caption='Error over iterations - resilient propagation agent 5' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<table border=1>
					<tr>
						<th><h3>
								Resilient propagation agent 1 needed
						...
						<%if (numberAgents >= 2)
                               {%>
						<th><h3>
								Resilient propagation agent 2 needed
						...
						<%if (numberAgents >= 3)
                               {%>
						<th><h3>
								Resilient propagation agent 3 needed
						...
						<%if (numberAgents >= 4)
                               {%>
						<th><h3>
								Resilient propagation agent 4 needed
						...
						<%if (numberAgents == 5)
                               {%>
						<th><h3>
								Resilient propagation agent 5 needed
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<h3>Neural resilient propagation committee agent 1:</h3>
				<table border=5>
					<%
        ...
        {
            %>
				<h3>Neural resilient propagation committee agent 2:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural resilient propagation committee agent 3:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural resilient propagation committee agent 4:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural resilient propagation committee agent 5:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
		...
		<h3>Neural resilient propagation committee has automatically
