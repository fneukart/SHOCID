...
<body>
	...
	<%
            ...
            int numberAgents = NeukartCApplicationJSP.getNumberCommitteeMembers();

            int numberInputNeurons = NeukartCApplicationJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = NeukartCApplicationJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = NeukartCApplicationJSP
                    .getCommitteeTrainingSet();
            int col = 0;
            double[][] inputValuesArray = NeukartCApplicationJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = NeukartCApplicationJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = NeukartCApplicationJSP.getAverageExpertValuesGUI();
    %>
	...
	<div id="AccordionCommittee" class="Accordion">
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<h3>Neural Neukart propagation committee agent 1:</h3>
				<table border=5>
					<%
