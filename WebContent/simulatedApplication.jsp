...
<title>Simulated Annealing Classification</title>
<style type="text/css">
body,td,th {
	...
	<form id="form1" name="form1" method="post"
		...
		<label for="agentInfo"></label> <input type="file" name="agentInfo" id="agentInfo"
			size="50" maxlength="100000" accept="text/*" />
			 ...
			 <span id="form1"> <input
			name="trainingMethod" type="hidden" id="trainingMethod" value="a" />
