	...
	<div id="AccordionSingle" class="Accordion">
		...
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Error over iterations - graph of
				SHL resilient propagation agent</div>
			<div class="AccordionPanelContent">
				...
				<%
					...
					if (FFANNAdaptiveResilientPropagationJSP.getErrorsSL(SHLAgentNumber).length > 500) {
						errorSelected = new double[500];
						jump = Math.round(FFANNAdaptiveResilientPropagationJSP
								.getErrorsSL(SHLAgentNumber).length / 500);

						for (int i = 0; i < 500; i++) {
							errorSelected[i] = FFANNAdaptiveResilientPropagationJSP
									.getErrorsSL(SHLAgentNumber)[position];
							position = position + jump;
						}
					} else {
						errorSelected = FFANNAdaptiveResilientPropagationJSP
			...
			<div class="AccordionPanelTab">Error over iterations - graph of
				MHL resilient propagation agent</div>
			<div class="AccordionPanelContent">
				...
				<%
					...
					if (FFANNAdaptiveResilientPropagationJSP.getErrorsML(MHLAgentNumber).length > 500) {
						errorSelected = new double[500];
						jump = Math.round(FFANNAdaptiveResilientPropagationJSP
