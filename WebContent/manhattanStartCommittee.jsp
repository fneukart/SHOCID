...
<%@ page import="shocid.ffann.training.FFANNManhattanUpdateJSP"%>
<%@ page import="shocid.ffann.committee.training.ManhattanUpdateCJSP"%>
...
<title>Manhattan Update Data Processing</title>
<link href="SpryAssets/SpryAccordion.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<h1 class="heading">Manhattan Update classification results</h1>
	...
	<%
            ...
            int numberInputNeurons = ManhattanUpdateCJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = ManhattanUpdateCJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = ManhattanUpdateCJSP
            ...
            int col = 0;
            double[][] inputValuesArray = ManhattanUpdateCJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = ManhattanUpdateCJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = ManhattanUpdateCJSP.getAverageExpertValuesGUI();
            ...
            switch(numberAgents)
                {
                case 1:
                    agent1Errors = ManhattanUpdateCJSP.getAgentErrors(1);
                    
                    agent1Epochs = HOANNCommitteeJSP.getExpertEpochs(1);
                    break;
                case 2:
                    agent1Errors = ManhattanUpdateCJSP.getAgentErrors(1);
                    agent2Errors = ManhattanUpdateCJSP.getAgentErrors(2);
                ...
                case 3:
                    agent1Errors = ManhattanUpdateCJSP.getAgentErrors(1);
                    agent2Errors = ManhattanUpdateCJSP.getAgentErrors(2);
                    agent3Errors = ManhattanUpdateCJSP.getAgentErrors(3);
                ...
                case 4:
                    ...
                    agent2Errors = ManhattanUpdateCJSP.getAgentErrors(2);
                    agent3Errors = ManhattanUpdateCJSP.getAgentErrors(3);
                    agent4Errors = ManhattanUpdateCJSP.getAgentErrors(4);
                ...
                case 5:
                    ...
                    agent3Errors = ManhattanUpdateCJSP.getAgentErrors(3);
                    agent4Errors = ManhattanUpdateCJSP.getAgentErrors(4);
                    agent5Errors = ManhattanUpdateCJSP.getAgentErrors(5);
            ...
            double[][] idealValuesArray = ManhattanUpdateCJSP
                    .getIdealValues();
            int epochs = ManhattanUpdateCJSP.getEpochs();
    %>

	<div id="AccordionCommittee" class="Accordion">
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Error over iterations - graphs
				per manhattan update agent</div>
			<div class="AccordionPanelContent">
                ...
                //Agent 1 Graph
                    //Graph
                        ...
                        strXMLA1 = "<graph caption='Error over iterations - manhattan update agent 1' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 2 Graph
                 //Graph
                     ...
                     int a2 = 0;
                     //Initialize graph element
                     strXMLA2 = "<graph caption='Error over iterations - manhattan update agent 2' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 3 Graph
                 //Graph
                     ...
                     int a3 = 0;
                     //Initialize graph element
                     strXMLA3 = "<graph caption='Error over iterations - manhattan update agent 3' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 4 Graph
                 //Graph
                     ...
                     int a4 = 0;
                     //Initialize graph element
                     strXMLA4 = "<graph caption='Error over iterations - manhattan update agent 4' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 5 Graph
                 //Graph
                     ...
                     int a5 = 0;
                     //Initialize graph element
                     strXMLA5 = "<graph caption='Error over iterations - manhattan update agent 5' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<table border=1>
					<tr>
						<th><h3>
								manhattan update agent 1 needed
						...
						<%if (numberAgents >= 2)
                               {%>
						<th><h3>
								manhattan update agent 2 needed
						...
						<%if (numberAgents >= 3)
                               {%>
						<th><h3>
								manhattan update agent 3 needed
						...
						<%if (numberAgents >= 4)
                               {%>
						<th><h3>
								manhattan update agent 4 needed
						...
						<%if (numberAgents == 5)
                               {%>
						<th><h3>
								manhattan update agent 5 needed
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<h3>Neural manhattan update committee agent 1:</h3>
				<table border=5>
					<%
        ...
        {
            %>
				<h3>Neural manhattan update committee agent 2:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural manhattan update committee agent 3:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural manhattan update committee agent 4:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural manhattan update committee agent 5:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
		...
		<h3>Neural manhattan update committee has automatically been
							saved under SHOCID\committees</h3>
