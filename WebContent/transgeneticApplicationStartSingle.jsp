...
// 					+ request.getParameter("output");
			...
			MLDataSet trainingSet = shocid.cortical.CorticalApplicationJSP.getTrainingSet();
			BasicNetwork network = shocid.cortical.CorticalApplicationJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = shocid.cortical.CorticalApplicationJSP
					.getInputValues();
			double[][] outputValuesArray = shocid.cortical.CorticalApplicationJSP
					.getOutputValues();
		%>
