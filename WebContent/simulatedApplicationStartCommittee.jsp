...
<%@ page
	import="shocid.ffann.committee.application.SimulatedAnnealingCApplicationJSP"%>
...
<body>
	...
	<%
            ...
            int numberAgents = SimulatedAnnealingCApplicationJSP.getNumberCommitteeMembers();

            int numberInputNeurons = SimulatedAnnealingCApplicationJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = SimulatedAnnealingCApplicationJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = SimulatedAnnealingCApplicationJSP
                    .getCommitteeTrainingSet();
            int col = 0;
            double[][] inputValuesArray = SimulatedAnnealingCApplicationJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = SimulatedAnnealingCApplicationJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = SimulatedAnnealingCApplicationJSP.getAverageExpertValuesGUI();
    %>
