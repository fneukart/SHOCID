...
<%@ page import="shocid.ffann.application.FFANNManhattanUpdateApplicationJSP"%>
...
<body>
	<h1 class="heading">Manhattan Update classification results</h1>
		...
		<%
			...
			MLDataSet trainingSet = FFANNManhattanUpdateApplicationJSP.getTrainingSet();
			BasicNetwork network = FFANNManhattanUpdateApplicationJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNManhattanUpdateApplicationJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNManhattanUpdateApplicationJSP
					.getOutputValues();
		%>
