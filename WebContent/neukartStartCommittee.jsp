...
<%@ page import="shocid.neukart.committee.NeukartCJSP"%>
...
<body>
	<h1 class="heading">Neukart classification results</h1>
	...
	<%
            ...
            int numberInputNeurons = NeukartCJSP.getNumberInputNeurons();
            int numberOutputNeurons = NeukartCJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = NeukartCJSP
            ...
            int col = 0;
            double[][] inputValuesArray = NeukartCJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = NeukartCJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = NeukartCJSP.getAverageExpertValuesGUI();
            ...
            switch(numberAgents)
                {
                case 1:
                    agent1Errors = NeukartCJSP.getAgentErrors(1);
                    
                    agent1Epochs = HOANNCommitteeJSP.getExpertEpochs(1);
                    break;
                case 2:
                    agent1Errors = NeukartCJSP.getAgentErrors(1);
                    agent2Errors = NeukartCJSP.getAgentErrors(2);
                ...
                case 3:
                    agent1Errors = NeukartCJSP.getAgentErrors(1);
                    agent2Errors = NeukartCJSP.getAgentErrors(2);
                    agent3Errors = NeukartCJSP.getAgentErrors(3);
                ...
                case 4:
                    ...
                    agent2Errors = NeukartCJSP.getAgentErrors(2);
                    agent3Errors = NeukartCJSP.getAgentErrors(3);
                    agent4Errors = NeukartCJSP.getAgentErrors(4);
                ...
                case 5:
                    ...
                    agent3Errors = NeukartCJSP.getAgentErrors(3);
                    agent4Errors = NeukartCJSP.getAgentErrors(4);
                    agent5Errors = NeukartCJSP.getAgentErrors(5);
	...
	<div id="AccordionCommittee" class="Accordion">
			...
			<div class="AccordionPanelContent">
                ...
                //Agent 1 Graph
                    //Graph
                        ...
                        strXMLA1 = "<graph caption='Error over generations - genetic Neukart agent 1' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 2 Graph
                 //Graph
                     ...
                     int a2 = 0;
                     //Initialize graph element
                     strXMLA2 = "<graph caption='Error over generations - genetic Neukart agent 2' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 3 Graph
                 //Graph
                     ...
                     int a3 = 0;
                     //Initialize graph element
                     strXMLA3 = "<graph caption='Error over generations - genetic Neukart agent 3' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 4 Graph
                 //Graph
                     ...
                     int a4 = 0;
                     //Initialize graph element
                     strXMLA4 = "<graph caption='Error over generations - genetic Neukart agent 4' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 5 Graph
                 //Graph
                     ...
                     int a5 = 0;
                     //Initialize graph element
                     strXMLA5 = "<graph caption='Error over generations - genetic Neukart agent 5' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
		...
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Neuron outputs per genetic
				Neukart agent</div>
			<div class="AccordionPanelContent">
				<h3>Neural genetic Neukart committee agent 1:</h3>
				<table border=5>
					<%
        ...
        {
            %>
				<h3>Neural genetic Neukart committee agent 2:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural genetic Neukart committee agent 3:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural genetic Neukart committee agent 4:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural genetic Neukart committee agent 5:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
