...
<%@ page import="shocid.cortical.CorticalCJSP"%>
...
<body>
	<h1 class="heading">Cortical classification results</h1>
	...
	<%
            ...
            int numberInputNeurons = CorticalCJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = CorticalCJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = CorticalCJSP
            ...
            int col = 0;
            double[][] inputValuesArray = CorticalCJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = CorticalCJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = CorticalCJSP.getAverageExpertValuesGUI();
            ...
            switch(numberAgents)
                {
                case 1:
                    agent1Errors = CorticalCJSP.getAgentErrors(1);
                    
                    agent1Epochs = HOANNCommitteeJSP.getExpertEpochs(1);
                    break;
                case 2:
                    agent1Errors = CorticalCJSP.getAgentErrors(1);
                    agent2Errors = CorticalCJSP.getAgentErrors(2);
                ...
                case 3:
                    agent1Errors = CorticalCJSP.getAgentErrors(1);
                    agent2Errors = CorticalCJSP.getAgentErrors(2);
                    agent3Errors = CorticalCJSP.getAgentErrors(3);
                ...
                case 4:
                    ...
                    agent2Errors = CorticalCJSP.getAgentErrors(2);
                    agent3Errors = CorticalCJSP.getAgentErrors(3);
                    agent4Errors = CorticalCJSP.getAgentErrors(4);
                ...
                case 5:
                    ...
                    agent3Errors = CorticalCJSP.getAgentErrors(3);
                    agent4Errors = CorticalCJSP.getAgentErrors(4);
                    agent5Errors = CorticalCJSP.getAgentErrors(5);
	...
	<div id="AccordionCommittee" class="Accordion">
			...
			<div class="AccordionPanelContent">
                ...
                //Agent 1 Graph
                    //Graph
                        ...
                        strXMLA1 = "<graph caption='Error over generations - cortical agent 1' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 2 Graph
                 //Graph
                     ...
                     int a2 = 0;
                     //Initialize graph element
                     strXMLA2 = "<graph caption='Error over generations - cortical agent 2' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 3 Graph
                 //Graph
                     ...
                     int a3 = 0;
                     //Initialize graph element
                     strXMLA3 = "<graph caption='Error over generations - cortical agent 3' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 4 Graph
                 //Graph
                     ...
                     int a4 = 0;
                     //Initialize graph element
                     strXMLA4 = "<graph caption='Error over generations - cortical agent 4' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
            ...
            %> <%
             //Agent 5 Graph
                 //Graph
                     ...
                     int a5 = 0;
                     //Initialize graph element
                     strXMLA5 = "<graph caption='Error over generations - cortical agent 5' showValues='0' decimalPrecision='20' showgridbg='1' showNames='0'>";
		...
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Error over generations - values
				per cortical agent</div>
			<div class="AccordionPanelContent">
				<table border=1>
					<tr>
						<th><h3>
								Cortical agent 1 needed to evolve
						...
						<%if (numberAgents >= 2)
                               {%>
						<th><h3>
								Cortical agent 2 needed to evolve
						...
						<%if (numberAgents >= 3)
                               {%>
						<th><h3>
								Cortical agent 3 needed to evolve
						...
						<%if (numberAgents >= 4)
                               {%>
						<th><h3>
								Cortical agent 4 needed to evolve
						...
						<%if (numberAgents == 5)
                               {%>
						<th><h3>
								Cortical agent 5 needed to evolve
		...
		<div class="AccordionPanel">
			<div class="AccordionPanelTab">Neuron outputs per genetic
				cortical agent</div>
			<div class="AccordionPanelContent">
				<h3>Neural cortical committee agent 1:</h3>
				<table border=5>
					<%
        ...
        {
            %>
				<h3>Neural cortical committee agent 2:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural cortical committee agent 3:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural cortical committee agent 4:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural cortical committee agent 5:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
