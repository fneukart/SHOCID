...
<body>
	...
	<%
            ...
            int numberAgents = NEATCApplicationJSP.getNumberCommitteeMembers();

            int numberInputNeurons = NEATCApplicationJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = NEATCApplicationJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = NEATCApplicationJSP
                    .getCommitteeTrainingSet();
            int col = 0;
            double[][] inputValuesArray = NEATCApplicationJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = NEATCApplicationJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = NEATCApplicationJSP.getAverageExpertValuesGUI();
    %>
	...
	<div id="AccordionCommittee" class="Accordion">
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<h3>Neural NEAT propagation committee agent 1:</h3>
				<table border=5>
					<%
