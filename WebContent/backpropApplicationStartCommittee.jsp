...
<%@ page
	import="shocid.ffann.committee.application.BackPropagationCApplicationJSP"%>
...
<script language="JavaScript"
	src="C:\\Users\\Florian Neukart\\workspace\\SHOCID_310_withoutDB\\FusionChartsFree\\JSClass\\FusionCharts.js"></script>
...
//            String inputFilePath = "C:\\Users\\Florian Neukart\\workspace\\SHOCID_310_withoutDB\\"
//                    + request.getParameter("input");
//            String outputFilePath = "C:\\Users\\Florian Neukart\\workspace\\SHOCID_310_withoutDB\\"
//                    + request.getParameter("output");
            ...
            int numberAgents = BackPropagationCApplicationJSP.getNumberCommitteeMembers();

            int numberInputNeurons = BackPropagationCApplicationJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = BackPropagationCApplicationJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = BackPropagationCApplicationJSP
                    .getCommitteeTrainingSet();
            int col = 0;
            double[][] inputValuesArray = BackPropagationCApplicationJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = BackPropagationCApplicationJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = BackPropagationCApplicationJSP.getAverageExpertValuesGUI();
    %>
