...
<%@ page
	import="shocid.ffann.committee.application.GeneticAlgorithmCApplicationJSP"%>
...
<script language="JavaScript"
	src="C:\\Users\\Florian Neukart\\workspace\\SHOCID\\FusionChartsFree\\JSClass\\FusionCharts.js"></script>
...
<body>
	...
	<%
            ...
            String inputFilePath = "C:\\Users\\Florian Neukart\\workspace\\SHOCID\\"
                    + request.getParameter("input");
            String outputFilePath = "C:\\Users\\Florian Neukart\\workspace\\SHOCID\\"
            ...
            int numberAgents = GeneticAlgorithmCApplicationJSP.getNumberCommitteeMembers();

            int numberInputNeurons = GeneticAlgorithmCApplicationJSP
                    .getNumberInputNeurons();
            int numberOutputNeurons = GeneticAlgorithmCApplicationJSP.getNumberOutputNeurons();
            MLDataSet trainingSet = GeneticAlgorithmCApplicationJSP
                    .getCommitteeTrainingSet();
            int col = 0;
            double[][] inputValuesArray = GeneticAlgorithmCApplicationJSP.getInputValues();
            
            double[][][] outputValuesArrayCommittee = GeneticAlgorithmCApplicationJSP.getOverallOutputGUI();
            double[][] averageExpertValuesArray = GeneticAlgorithmCApplicationJSP.getAverageExpertValuesGUI();
    %>
	...
	<div id="AccordionCommittee" class="Accordion">
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<h3>Neural genetic algorithm propagation committee agent 1:</h3>
				<table border=5>
					<%
        ...
        {
            %>
				<h3>Neural genetic algorithm committee agent 2:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural genetic algorithm committee agent 3:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural genetic algorithm committee agent 4:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
        ...
        {
            %>
				<h3>Neural genetic algorithm committee agent 5:</h3>
				<table border=5>
					<%
                        for (int i = 0; i < inputValuesArray.length; i++) {
                    %>
