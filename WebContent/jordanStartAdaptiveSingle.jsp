		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<%
					...
					JordanAdaptiveGeneticAlgorithmJSP.getBestSHLNetworkQuality();
						bestNetwork = JordanAdaptiveGeneticAlgorithmJSP
				...
				<p>
					<%
						JordanAdaptiveGeneticAlgorithmJSP.getBestSHLNetworkQuality();
							hn1 = JordanAdaptiveGeneticAlgorithmJSP
					...
					<%
						...
						bestEpochs = JordanAdaptiveGeneticAlgorithmJSP.getBestEpochs();
					%>
				...
				<table border=0 width=100%>
					<%
						...
						int epochsSHL = 0;
						for (int i = 0; i < JordanAdaptiveGeneticAlgorithmJSP
								.getQualitySHLArray().length; i++) {
							qualitySHL = JordanAdaptiveGeneticAlgorithmJSP
									.getQualitySHLArray(i);
							epochsSHL = JordanAdaptiveGeneticAlgorithmJSP.getEpochsSL(i);
					%>
					<tr>
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<form id="form1" name="form1" method="post"
					action="jordanAdaptiveSingleDetails.jsp">
					<table>
						<tr>
							<td>
								<div id="SHLAgentDetails">
									<label for="SHLAgentDetails">SHL agent evolution
										...
										name="showSHLAgentDetails" size="1" id="showSHLAgentDetails">
											<%
												for (int networks = 0; networks < JordanAdaptiveGeneticAlgorithmJSP
