...
<%@ page import="shocid.neukart.application.NeukartApplicationJSP"%>
...
<body>
	<h1 class="heading">Neukart classification results</h1>
		...
		<%
			...
			MLDataSet trainingSet = NeukartApplicationJSP.getTrainingSet();
			BasicNetwork network = NeukartApplicationJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = NeukartApplicationJSP
					.getInputValues();
			double[][] outputValuesArray = NeukartApplicationJSP
					.getOutputValues();
		%>
