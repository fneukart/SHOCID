		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<%
					...
					if (FFANNAdaptiveGeneticAlgorithmJSP.getBestSHLNetworkQuality() < FFANNAdaptiveGeneticAlgorithmJSP
							.getBestMHLNetworkQuality()) {
						bestNetwork = FFANNAdaptiveGeneticAlgorithmJSP
				...
				<p>
					<%
						if (FFANNAdaptiveGeneticAlgorithmJSP.getBestSHLNetworkQuality() < FFANNAdaptiveGeneticAlgorithmJSP
								.getBestMHLNetworkQuality()) {
							hn1 = FFANNAdaptiveGeneticAlgorithmJSP
					...
					<%
							...
							hn1 = FFANNAdaptiveGeneticAlgorithmJSP
									.getBestHiddenLayer1Neurons();
							hn2 = FFANNAdaptiveGeneticAlgorithmJSP
					...
					<%
						...
						bestEpochs = FFANNAdaptiveGeneticAlgorithmJSP.getBestEpochs();
					%>
				...
				<table border=0 width=100%>
					<%
						...
						int epochsSHL = 0;
						for (int i = 0; i < FFANNAdaptiveGeneticAlgorithmJSP
								.getQualitySHLArray().length; i++) {
							qualitySHL = FFANNAdaptiveGeneticAlgorithmJSP
									.getQualitySHLArray(i);
							epochsSHL = FFANNAdaptiveGeneticAlgorithmJSP.getEpochsSL(i);
					%>
					<tr>
				...
				<table border=0 width=100%>
					<%
						...
						for (int i = 0; i < FFANNAdaptiveGeneticAlgorithmJSP
							...
							qualityMHL = FFANNAdaptiveGeneticAlgorithmJSP
									.getQualityMHLArray(i);
							epochsMHL = FFANNAdaptiveGeneticAlgorithmJSP.getEpochsML(i);
					%>
					<tr>
		...
		<div class="AccordionPanel">
			...
			<div class="AccordionPanelContent">
				<form id="form1" name="form1" method="post"
					action="geneticAdaptiveSingleDetails.jsp">
					<table>
						<tr>
							<td>
								<div id="SHLAgentDetails">
									<label for="SHLAgentDetails">SHL agent evolution
										...
										name="showSHLAgentDetails" size="1" id="showSHLAgentDetails">
											<%
												for (int networks = 0; networks < FFANNAdaptiveGeneticAlgorithmJSP
