...
<%@ page import="shocid.ffann.training.FFANNResilientPropagationJSP"%>
...
<body>
	...
	<div id="AccordionSingle" class="Accordion">
		<%
			int numberInputNeurons = FFANNResilientPropagationJSP
					.getNumberInputNeurons();
        int numberOutputNeurons = Integer
        .valueOf(numberOutputNeuronsString).intValue();
			MLDataSet trainingSet = FFANNResilientPropagationJSP
					.getTrainingSet();
			BasicNetwork network = FFANNResilientPropagationJSP.getNetwork();
			int col = 0;
			double[][] inputValuesArray = FFANNResilientPropagationJSP
					.getInputValues();
			double[][] outputValuesArray = FFANNResilientPropagationJSP
					.getOutputValues();
			double[][] idealValuesArray = FFANNResilientPropagationJSP
					.getIdealValues();
			double[] error = FFANNResilientPropagationJSP.getError();
			int epochs = FFANNResilientPropagationJSP.getEpochs();
		%>
