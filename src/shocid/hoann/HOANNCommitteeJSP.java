...
import shocid.ffann.committee.training.GeneticAlgorithmCJSP;
...
import shocid.ffann.committee.training.SimulatedAnnealingCJSP;
import shocid.neukart.committee.NeukartCJSP;
import shocid.neatpopulation.*;
import shocid.normalization.NormalizeCSV2CSV;
import shocid.normalization.NormalizeCSV2NDS;
import shocid.cortical.CorticalCJSP;
import shocid.elman.ElmanCJSP;
import shocid.jordan.*;
import shocid.readFile.ReadWithScanner;


public class HOANNCommitteeJSP extends Thread implements Serializable {
	...
	public static RBFNetwork[] trainedCommitteeRBF;
	public static SOM[] trainedCommitteeSOM;
		...
		case 1:
			...
			{		
				...
				for (int numberExpert = 0; numberExpert < getNumberExperts(); numberExpert++)
				{
					...
					committeeBP[numberExpert] = new BackPropagationCJSP(numberExpertString,getNumberInputNeurons(),getNumberHiddenNeurons(),getNumberOutputNeurons(),getCommitteeTrainingSet(), saveCommittee, allowedError);
			...
			{
				GeneticAlgorithmCJSP committeeGA[];
				committeeGA = new GeneticAlgorithmCJSP[getNumberExperts()];
				trainedCommitteeMemberNames = new String[getNumberExperts()];
				//initialize the epoch array for all agents
				expertEpochs = new int[HOANNCommitteeJSP.getNumberExperts()];
				...
				//First initialization of the overallOutput-Variable in the committee Training class
				GeneticAlgorithmCJSP.initializeOverallOutput(overallOutput);
				...
				{
					String numberExpertString = (new Integer(numberExpert+1)).toString();
					committeeGA[numberExpert] = new GeneticAlgorithmCJSP(numberExpertString,getNumberInputNeurons(),getNumberHiddenNeurons(),getNumberOutputNeurons(),getCommitteeTrainingSet(), saveCommittee, allowedError);
				...
				GeneticAlgorithmCJSP.committeeOutput();
				GeneticAlgorithmCJSP.saveCommittee(saveCommittee);
			}

			else if (trainingMethod.equals("a"))
			{
				SimulatedAnnealingCJSP committeeSA[];
				committeeSA = new SimulatedAnnealingCJSP[getNumberExperts()];
				trainedCommitteeMemberNames = new String[getNumberExperts()];
				//initialize the epoch array for all agents
				expertEpochs = new int[HOANNCommitteeJSP.getNumberExperts()];
				...
				//First initialization of the overallOutput-Variable in the committee Training class
				SimulatedAnnealingCJSP.initializeOverallOutput(overallOutput);
				...
				{
					String numberExpertString = (new Integer(numberExpert+1)).toString();
					committeeSA[numberExpert] = new SimulatedAnnealingCJSP(numberExpertString,getNumberInputNeurons(),getNumberHiddenNeurons(),getNumberOutputNeurons(),getCommitteeTrainingSet(), saveCommittee, allowedError);
				...
				SimulatedAnnealingCJSP.committeeOutput();
				SimulatedAnnealingCJSP.saveCommittee(saveCommittee);
			}
			...
			{		
				...
				{
					String numberExpertString = (new Integer(numberExpert+1)).toString();
					committeeRP[numberExpert] = new ResilientPropagationCJSP(numberExpertString,getNumberInputNeurons(),getNumberHiddenNeurons(),getNumberOutputNeurons(),getCommitteeTrainingSet(), saveCommittee, allowedError);
			...
			{		
				...
				{
					String numberExpertString = (new Integer(numberExpert+1)).toString();
					committeeMU[numberExpert] = new ManhattanUpdateCJSP(numberExpertString,getNumberInputNeurons(),getNumberHiddenNeurons(),getNumberOutputNeurons(),getCommitteeTrainingSet(), saveCommittee, allowedError);
			...
			{		
				...
				{
					String numberExpertString = (new Integer(numberExpert+1)).toString();
					committeeRB[numberExpert] = new RadialBasisCJSP(numberExpertString,getNumberInputNeurons(),getNumberHiddenNeurons(),getNumberOutputNeurons(),getCommitteeTrainingSet(), saveCommittee, allowedError);
			...
			{		
				...
				{
					String numberExpertString = (new Integer(numberExpert+1)).toString();
					committeeLM[numberExpert] = new LevenbergMarquardtCJSP(numberExpertString,getNumberInputNeurons(),getNumberHiddenNeurons(),getNumberOutputNeurons(),getCommitteeTrainingSet(), saveCommittee, allowedError);
			...
			{
				NeukartCJSP committeeNE[];
				committeeNE = new NeukartCJSP[getNumberExperts()];
				trainedCommitteeMemberNames = new String[getNumberExperts()];
				//initialize the epoch array for all agents
				expertEpochs = new int[HOANNCommitteeJSP.getNumberExperts()];
				...
				//First initialization of the overallOutput-Variable in the committee Training class
				NeukartCJSP.initializeOverallOutput(overallOutput);
				...
				{
					String numberExpertString = (new Integer(numberExpert+1)).toString();
					committeeNE[numberExpert] = new NeukartCJSP(numberExpertString,getNumberInputNeurons(),getNumberHiddenNeurons(),getNumberOutputNeurons(),getCommitteeTrainingSet(), saveCommittee, allowedError);

					committeeThreads[numberExpert] = new Thread(committeeNE[numberExpert]);
				}
				...
				NeukartCJSP.committeeOutput();
				NeukartCJSP.saveCommittee(saveCommittee);
			}

			else if (trainingMethod.equals("cortical"))
			{
				CorticalCJSP committeeCort[];
				committeeCort = new CorticalCJSP[getNumberExperts()];
				trainedCommitteeMemberNames = new String[getNumberExperts()];
				//initialize the epoch array for all agents
				expertEpochs = new int[HOANNCommitteeJSP.getNumberExperts()];
				...
				//First initialization of the overallOutput-Variable in the committee Training class
				CorticalCJSP.initializeOverallOutput(overallOutput);
				...
				{
					String numberExpertString = (new Integer(numberExpert+1)).toString();
					committeeCort[numberExpert] = new CorticalCJSP(numberExpertString,getNumberInputNeurons(),getNumberHiddenNeurons(),getNumberOutputNeurons(),getCommitteeTrainingSet(), saveCommittee, allowedError);

					committeeThreads[numberExpert] = new Thread(committeeCort[numberExpert]);
				}
				...
				CorticalCJSP.committeeOutput();
				CorticalCJSP.saveCommittee(saveCommittee);
			}
...
//			}
		...
		case 2:
			...
			{	
				...
				{
					String numberExpertString = (new Integer(numberExpert+1)).toString();
					committeeElman[numberExpert] = new ElmanCJSP(numberExpertString,getNumberInputNeurons(),getNumberHiddenNeurons(),getNumberOutputNeurons(),getCommitteeTrainingSet(), saveCommittee, allowedError);
			...
			{	
				...
				{
					String numberExpertString = (new Integer(numberExpert+1)).toString();
					committeeJordan[numberExpert] = new JordanCJSP(numberExpertString,getNumberInputNeurons(),getNumberHiddenNeurons(),getNumberOutputNeurons(),getCommitteeTrainingSet(), saveCommittee, allowedError);
		...
		case 3:
			if (trainingMethod.equals("neat"))
			{
				...
				{
					String numberExpertString = (new Integer(numberExpert+1)).toString();
					committeeNEAT[numberExpert] = new NEATPopulationCJSP(numberExpertString,getNumberInputNeurons(),getNumberHiddenNeurons(),getNumberOutputNeurons(),getCommitteeTrainingSet(), saveCommittee, allowedError);
	...
	public static void setTrainedCommittee(int agentPosition, BasicNetwork network)
	{
		trainedCommittee[agentPosition] = network; 
	}
	...
	public static void setTrainedCommitteeSOM(int agentPosition, SOM som)
	{
		trainedCommitteeSOM[agentPosition] = som; 
	}
	
	public static SOM[] getTrainedCommitteeSOM()
	{
		return trainedCommitteeSOM;
	}
	
	public static void setTrainedCommitteeRBF(int agentPosition, RBFNetwork rbfNetwork)
	{
		trainedCommitteeRBF[agentPosition] = rbfNetwork; 
	}
	
	public static RBFNetwork[] getTrainedCommitteeRBF()
	{
		return trainedCommitteeRBF;
	}
