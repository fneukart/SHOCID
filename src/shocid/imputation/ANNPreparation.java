...
public class ANNPreparation extends Thread 
{
	...
	public static void prepare() throws Throwable
	{
		...
		ANNPreparation x=new ANNPreparation(getImputeFilePath());

		String targetReplace = "imputation\\norm_impute_prepared.csv";
		...
		String targetComplete = "imputation\\norm_impute_complete.csv";
		...
		String targetIncomplete = "imputation\\norm_impute_incomplete.csv";
		...
		String targetTraining = "imputation\\norm_impute_training.csv";
		...
		String targetBase = "imputation\\baseFile.csv";
		...
		setImputationNetwork("imputation\\imputation_FFANNGA.net");
	...
	public ANNPreparation(String FileName)
	{
		ANNPreparation.fileName=FileName;
	}

	public ANNPreparation()
	{
	...
	public static void prepareImputation(int numberInputNeurons, int numberOutputNeurons, String trainingFile, boolean networkOnlyPositiveInput, String baseFilePath)
	{
		...
		ffannga.run(network, numberInputNeurons, numberHiddenNeurons, numberOutputNeurons, trainingSet, networkOnlyPositiveInput, 0.0001, askForSave, "y");
	}
