...
public class NormalizeNDS2NDS extends TestCase {
	
	public NormalizeNDS2NDS()
	{

	}

	public MLDataSet normalizeMultiplicative(NeuralDataSet trainingSet, int numberInputNeurons, int numberOutputNeurons)
	{	
		...
		{
			norm.addInputField(inputFieldArray[i] = new InputFieldMLDataSet(true,trainingSet,i));
		}
	...
	public MLDataSet normalizeRangeMapped(NeuralDataSet trainingSet, int numberInputNeurons, int numberOutputNeurons/*, double low, double high*/)
	{		
		InputField[] inputFieldArray = new InputField[numberInputNeurons + numberOutputNeurons];
