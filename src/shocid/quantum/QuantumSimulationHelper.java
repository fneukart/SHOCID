...
public class QuantumSimulationHelper extends QuantumSimulationTraining<Double> {

	/**
	 * The class that this class should report to.
	 */
	private QuantumSimulation owner;
	 ...
	 */
	public QuantumSimulationHelper(
			final QuantumSimulation owner) {
		this.owner = owner;
