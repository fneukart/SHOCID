...
import org.encog.ml.anneal.FreeformSimulatedAnnealing;
 ...
 * 
 */
public class FreeformNeuralSimulatedAnnealingHelper extends FreeformSimulatedAnnealing<Double> {

	/**
	 * The class that this class should report to.
	 */
	private FreeformNeuralSimulatedAnnealing owner;

	/**
	 * Constructs this object.
	 * 
	 * @param owner
	 *            The owner of this class, that receives all messages.
	 */
	public FreeformNeuralSimulatedAnnealingHelper(
			final FreeformNeuralSimulatedAnnealing owner) {
		this.owner = owner;
