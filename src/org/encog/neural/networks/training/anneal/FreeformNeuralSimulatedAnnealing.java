 ...
 * 
 */
public class FreeformNeuralSimulatedAnnealing extends BasicTraining {
	 ...
	 */
	private final FreeformNeuralSimulatedAnnealingHelper anneal;
	 ...
	 */
	public FreeformNeuralSimulatedAnnealing(final MLEncodable network,
		...
		this.anneal = new FreeformNeuralSimulatedAnnealingHelper(this);
	...
	public double[] getArray() {
		return NetworkCODEC
				.networkToArray(FreeformNeuralSimulatedAnnealing.this.network);
	}
	...
	public void putArray(final double[] array) {
		NetworkCODEC.arrayToNetwork(array,
				FreeformNeuralSimulatedAnnealing.this.network);
	}
